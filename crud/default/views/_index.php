...
<?php if($generator->pdf): ?>
        <?= "<?= " ?>Html::a('<i class="fa fas fa-hand-point-up"></i> ' . <?= $generator->generateString('Print PDF')?>,
            ['pdf', <?= $urlParams ?>],
            [
...
<?php if($generator->saveAsNew): ?>
        <?= "<?= " ?>Html::a('<i class="fa fas fa-hand-point-up"></i> ' . <?= $generator->generateString('Save As New')?>,
